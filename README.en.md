...
| **AI provider** | Detect and use local AI CLIs through a provider abstraction instead of hard-coding one agent. The providers verified for 0.5.0 are **Claude Code**, **Codex** and **Antigravity (agy)**; each must be installed and signed in on your machine. |
